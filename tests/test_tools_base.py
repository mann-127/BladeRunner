...
class MockTool(Tool):
    ...
    def execute(self, **kwargs):
        ...
        return f"Mock result: {input_value}"
...
def test_tool_to_definition_format():
...
def test_tool_registry_execute_by_name():
...
def test_tool_registry_handles_execution_errors():
